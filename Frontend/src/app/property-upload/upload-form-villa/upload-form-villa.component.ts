...
@Component({
  selector: 'app-upload-form-villa',
  templateUrl: './upload-form-villa.component.html',
  styleUrls: ['./upload-form-villa.component.css']
})
export class UploadFormVillaComponent implements OnInit {
