...
@Component({
  selector: 'app-upload-form-compound',
  templateUrl: './upload-form-compound.component.html',
  styleUrls: ['./upload-form-compound.component.css']
})
export class UploadFormCompoundComponent implements OnInit {
