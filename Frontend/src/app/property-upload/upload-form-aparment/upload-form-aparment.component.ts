...
@Component({
  selector: 'app-upload-form-aparment',
  templateUrl: './upload-form-aparment.component.html',
  styleUrls: ['./upload-form-aparment.component.css']
})
export class UploadFormAparmentComponent implements OnInit {
  ...
  ownership = [
    {id : '1', value : 'First_Owner', name :'I here by that, i owned this Property'},
    {id : '2', value : 'Second_Owner', name : 'I only managed this Property'}
  ]
