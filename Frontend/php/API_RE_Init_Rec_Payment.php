...
if($postdata){
// echo $order_date = $postdata['Order_date']; 
// // echo $order_date = "2023-04-10"; 
// echo $token_id = $postdata['Token_ID'];
// echo $txn_desc= $postdata['Txn_Desc'];
// echo $month = $postdata['rec_month'];
// echo $payment_id = $postdata['payment_id'];
// echo $real_estate_id = $postdata['real_estate_id'];
// echo $rent = $postdata['rent'];
// echo $year = $postdata['rec_year'];

 $order_date = $postdata['Order_date']; 
 $token_id = $postdata['Token_ID'];
 $txn_desc= $postdata['Txn_Desc'];
 $month = $postdata['rec_month'];
 $payment_id = $postdata['payment_id'];
 $real_estate_id = $postdata['real_estate_id'];
 $rent = $postdata['rent'];
 $year = $postdata['rec_year'];
